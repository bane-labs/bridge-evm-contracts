...
- `config/networks/<network>.local.json` can override network values locally, for example container-specific RPC URLs. It must still include `"name": "<network>"`, and the CLI rejects mismatches.
