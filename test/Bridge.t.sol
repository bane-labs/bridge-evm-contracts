...
contract BridgeImplTest is Test,SigUtils {
    ...
    address neoXToken = address(0x6782);
    ...
    // function testFailRegisterTokenWithZeroAddress() public {
    //     vm.prank(governor);
    //     bridgeImpl.registerToken(address(0), validConfig);
    // }


    // function testFailRegisterTokenWithInvalidAmount() public {
    //     vm.prank(governor);
    ...
    // function testFailRegisterTokenWithInvalidNeoN3TokenAddress() public {
    //     vm.prank(governor);
    //     StorageTypes.TokenConfig memory invalidConfig = StorageTypes.TokenConfig({
    ...
    // function testFailRegisterTokenAlreadyRegistered() public {
    //     vm.prank(governor);
    //     bridgeImpl.registerToken(neoXToken, validConfig);
