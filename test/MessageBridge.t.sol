...
import {ExecutionManager} from "../contracts/bridge/ExecutionManager.sol";
...
contract MessageBridgeTest is Test, SigUtils {
    ...
    function setUp() public {
        ...
        vm.prank(governor);
        bridgeProxy.setMessageExecutor(address(executionManager));
    ...
    function test_MessageBridgePauseUnpause() public {
        ...
        messages[0] = StorageTypes.MessageData({
            ...
            metadata: StorageTypes.Metadata({version: 1, sender: address(this), timestamp: block.timestamp})
        });
    ...
    function test_StoreAndExecuteMessageReentrancy() public {
        ...
        ReentrancyAttacker attacker = new ReentrancyAttacker(address(bridgeProxy));
        ...
        vm.expectRevert(abi.encodeWithSelector(BridgeStorage.MessageAlreadyExecuted.selector, nonce));
    ...
    function test_StoreAndExecuteMessageMultipleTimes() public {
        ...
        result = bridgeProxy.executeMessage(nonce2);
    ...
    function test_StoreAndExecuteRefundReentrancyAttack() public {
        ...
        RefundReentrancyAttacker attacker = new RefundReentrancyAttacker(address(bridgeProxy));
        ...
        StorageTypes.Result memory result = bridgeProxy.executeMessage{value: sentValue}(nonce);
    ...
    function test_StoreMultipleMessagesWithMetadata() public {
        ...
        StorageTypes.Call memory call1 = StorageTypes.Call({
            allowFailure: false,
            requiresResponse: false,
            target: address(testContract),
            value: 0,
        ...
        StorageTypes.Call memory call2 = StorageTypes.Call({
            allowFailure: false,
            requiresResponse: false,
            target: address(testContract),
            value: 1 ether,
    ...
    function test_StoreMessageWithCustomMetadata() public {
        ...
        messages[0] = StorageTypes.MessageData({
            nonce: 1,
            message: message,
            metadata: StorageTypes.Metadata({version: 1, sender: customSender, timestamp: customTimestamp})
        });
