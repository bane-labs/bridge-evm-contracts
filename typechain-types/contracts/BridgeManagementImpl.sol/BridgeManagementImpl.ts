...
export interface BridgeManagementImplInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "GOV_ADMIN"
      | "SELF"
...
export interface BridgeManagementImpl extends BaseContract {
  connect(runner?: ContractRunner | null): BridgeManagementImpl;
  waitForDeployment(): Promise<this>;

  interface: BridgeManagementImplInterface;
